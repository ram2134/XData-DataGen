...
;------------------------------------------------------------
 ...
 (assert  (or  ( not (=  (instructor_ID0 (select O_instructor 1)) (teaches_ID0 (select O_teaches 1)) ) )  ( not (=  (instructor_ID0 (select O_instructor 2)) (teaches_ID0 (select O_teaches 2)) ) ) 
		)) 
